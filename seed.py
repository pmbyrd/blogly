...
p3 = Post(title="Test 1", content="Hello, hello", user_id=2)
p4 = Post(title="Test 2", content="Hey, hey", user_id=2)
p5 = Post(title="Test 1", content="Hello, hello", user_id=3)
p6 = Post(title="Test 2", content="Hey, hey", user_id=3)
